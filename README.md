...
* [maxipalay/localization\_and\_mapping](https://github.com/maxipalay/localization_and_mapping) - Localization and mapping system in ROS2, C++
...
* [Ikunio/Lidar\_nav2\_ws](https://github.com/Ikunio/Lidar_nav2_ws) - 基于 Livox MID-360 3D LiDAR 的 ROS 2 自主导航工作空间，集成 LIO 里程计、重定位、Nav2    导航，支持仿真与实机部署。
...
* [wh200720041/ssl\_slam3](https://github.com/wh200720041/ssl_slam3) - SSL\_LIO: Solid-State LiDAR based LiDAR-Inertial SLAM

* [OVI-MAP/OVI-MAP](https://github.com/OVI-MAP/OVI-MAP) - CVPR 2026 - Open-Vocabulary Instance-Semantic Mapping
...
* [oranfire/VINS-LPL](https://github.com/oranfire/VINS-LPL) -
...
* [zhouyong1234/my\_ekf\_package](https://github.com/zhouyong1234/my_ekf_package) - 使用卡尔曼滤波实现多传感器数据融合
...
* [DreamWaterFound/Codes](https://github.com/DreamWaterFound/Codes) - 自己的一些零散代码合集
...
* [suchetanrs/ORB-SLAM3-ROS2-Docker](https://github.com/suchetanrs/ORB-SLAM3-ROS2-Docker) - This repository contains everything needed to run ORB-SLAM3 on a docker container with ROS2 Humble with Ubuntu 22.04.
...
* [Geneta2580/HyVGGT-VO](https://github.com/Geneta2580/HyVGGT-VO) - HyVGGT-VO: Tightly Coupled Hybrid Dense Visual Odometry with Feed-Forward Models
...
* [kmk97/DGS-SLAM](https://github.com/kmk97/DGS-SLAM) - DGS-SLAM: Gaussian Splatting SLAM in Dynamic Environment
...
* [DennisRotondi/awesome-3D-scene-graphs](https://github.com/DennisRotondi/awesome-3D-scene-graphs) - Awesome 3D Scene Graphs: a curated list of 3D scene graph generation and related resources! Now with a companion website to explore the literature!
...
* [horipse01/3d-foundation-policy](https://github.com/horipse01/3d-foundation-policy) -
...
* [luohongk/Embodied-AI-Daily](https://github.com/luohongk/Embodied-AI-Daily) - 📚这个仓库是在arxiv上收集的有关VLN，VLA，World Model，SLAM，Gaussian Splatting,非线性优化等相关论文。每天都会自动更新！issue区域是最新10篇论文
