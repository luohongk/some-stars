...
*   [instructkr/claw-code](https://github.com/instructkr/claw-code) - Better Harness Tools, not merely storing the archive of leaked Claude Code but also make real things done. Now rewriting in Rust.
